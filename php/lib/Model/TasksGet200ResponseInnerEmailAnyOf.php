...
/**
 * TasksGet200ResponseInnerEmailAnyOf Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TasksGet200ResponseInnerEmailAnyOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_tasks_get_200_response_inner_email_anyOf';
    ...
    protected static array $openAPINullables = [
        'id' => false,
        'email_message_id' => false,
        'service_message_id' => false,
        'data_source' => false,
        'subject' => false
    ];
    ...
    */
     ...
     *
     * @param string $email_message_id email_message_id
     *
     * @return self
     */
    public function setEmailMessageId($email_message_id)
    {
        if (is_null($email_message_id)) {
            throw new \InvalidArgumentException('non-nullable email_message_id cannot be null');
        }
     ...
     *
     * @param string $service_message_id service_message_id
     *
     * @return self
     */
    public function setServiceMessageId($service_message_id)
    {
        if (is_null($service_message_id)) {
            throw new \InvalidArgumentException('non-nullable service_message_id cannot be null');
        }
