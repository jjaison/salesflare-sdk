...
public class ApiClient {
    ...
    public ApiClient() {
        ...
        authentications.put("apikey cookie  gid", new ApiKeyAuth("cookie", "_gid"));
        authentications.put("apikey cookie  hjsessionuser 374224", new ApiKeyAuth("cookie", "_hjsessionuser_374224"));
        authentications.put("apikey cookie ajs anonymous id", new ApiKeyAuth("cookie", "ajs_anonymous_id"));
        authentications.put("apikey cookie intercom-id-nhqftro2", new ApiKeyAuth("cookie", "intercom-id-nhqftro2"));
        authentications.put("apikey cookie intercom-device-id-nhqftro2", new ApiKeyAuth("cookie", "intercom-device-id-nhqftro2"));
        authentications.put("apikey cookie salesflare-session", new ApiKeyAuth("cookie", "salesflare-session"));
        authentications.put("apikey cookie ajs user id", new ApiKeyAuth("cookie", "ajs_user_id"));
        authentications.put("apikey cookie  hjsession 374224", new ApiKeyAuth("cookie", "_hjsession_374224"));
        authentications.put("apikey cookie intercom-session-nhqftro2", new ApiKeyAuth("cookie", "intercom-session-nhqftro2"));
        authentications.put("apikey header cookie", new ApiKeyAuth("header", "COOKIE"));
